...
#pragma warning restore CS0649
    ...
    Target Test => _ => _
        ...
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.PostgresFlex.Tests" / "Tamp.PostgresFlex.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.PostgresFlex" / "Tamp.PostgresFlex.csproj");
